...
_no_iss_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c"
_fake_iss_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyLCJpc3MiOiJodHRwOi8vbG9jYWxob3N0Ojg4ODgvYXV0aC9yZWFsbXMvZG9lcy1ub3QtZXhpc3QifQ.gpM3Ya0BheWvPXKDQ-Ezgkh5lUh6mdXBtdqSo_mjFFE"
...
def test_get_claims_invalid_token(token: Optional[str]) -> None:
    with pytest.raises(fastapi.HTTPException) as excinfo:
